...
class Renderer implements GLEventListener {
    ...
    public void display(GLAutoDrawable drawable) {
        ...
        gl.glLightfv(GL2.GL_LIGHT1, GL2.GL_POSITION, LightPos, 0);        // Position Light1
        ...
        gl.glGetFloatv(GL2.GL_MODELVIEW_MATRIX, Minv.e, 0);      // Retrieve ModelView Matrix (Stores In Minv)
        ...
        gl.glGetFloatv(GL2.GL_MODELVIEW_MATRIX, Minv.e, 0);      // Retrieve ModelView Matrix From Minv
